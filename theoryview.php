    ...
    if (isset($_GET['subject_name']) && isset($_GET['course_code'])) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<table>';
                echo '<tr><td colspan="3"><strong>Nature of the Course:<br></strong>Theory - (External Mark: 60/ Internal Mark: 40)<br>End Semester Mark Splitup: <strong>(End Semester Theory Maximum Marks- 100(Weightage- 60%))</strong></td></tr>';
                echo '</table>';
