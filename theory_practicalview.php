...
<head>
    ...
    <title>Theory-Practical View - SKASC</title>
    <style>
        body {
    ...
    if (isset($_GET['subject_name']) && isset($_GET['course_code'])) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<table>';
                echo '<tr><td colspan="3"><strong>Nature of the Course:<br></strong>Theory With Practical - (External Mark: 50/ Internal Mark: 50)<br>End Semester Mark Splitup: <strong>(End Semester Theory Maximum Marks- 100(Weightage- 25%), EndSemester Practical Maximum Marks- 100(Weightage- 25%))</strong></td></tr>';
                echo '</table>';
                ...
                echo '<table><tr><th colspan="3">Course Content:</th></tr>';
                $contents = explode("$\n", $row['course_content']);
