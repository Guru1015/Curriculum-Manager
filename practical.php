        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] . '?subject_name=' . urlencode($subject_name) . '&course_code=' . urlencode($course_code); ?>" method="post"> <!-- Pass subject_name and course_code in the URL -->
            ...
            <table id="content_table">
                ...
                <tr>
                    ...
                    <td><textarea name="lab_components[]" rows="4" required></textarea></td> <!-- Change here -->
                    <td><textarea name="co_mapping[]" rows="4" required></textarea></td>
                    <td><textarea name="rbt[]" rows="4" required></textarea></td>
                </tr>
            </table>
